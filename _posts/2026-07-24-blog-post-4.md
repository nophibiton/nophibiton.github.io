...
The limit state function is violated when the structures capacity is exceeded by the demand, $C\leq D$. Both capacity $C$ and demand $D$ are expressed in terms of the chosed EDP.
