...
where $x = [A_1,A_2 ]$. In this example, it is shown how a structural engineering problem is viewed in an optimization framework. Since there are a lot of available tools to solve optimization problems, the problem above can easily solve.
