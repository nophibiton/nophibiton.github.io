...
The goal is to find the *best* design or *optimal* design $x^*$ that will minimized the objective function $f(\cdot)$ and satisfy the constraint functions, $g_i(\cdot)$ and $h_j(\cdot)$. This a standard constrained optimization problem. This
